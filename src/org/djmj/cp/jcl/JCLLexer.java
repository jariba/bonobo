// $ANTLR 2.7.2: "JCLGrammar.g" -> "JCLLexer.java"$
...
public class JCLLexer extends antlr.CharScanner implements JCLParserTokenTypes, TokenStream
 {
public JCLLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public JCLLexer(Reader in) {
	this(new CharBuffer(in));
}
public JCLLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public JCLLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("constrained", this), new Integer(11));
	literals.put(new ANTLRHashString("class", this), new Integer(6));
	literals.put(new ANTLRHashString("enforce_if", this), new Integer(41));
	literals.put(new ANTLRHashString("constrain", this), new Integer(39));
	literals.put(new ANTLRHashString("extends", this), new Integer(8));
	literals.put(new ANTLRHashString("while", this), new Integer(18));
	literals.put(new ANTLRHashString("enforce", this), new Integer(42));
	literals.put(new ANTLRHashString("include", this), new Integer(4));
	literals.put(new ANTLRHashString("new", this), new Integer(32));
...
tryAgain:
		...
		case '8':  case '9':
		{
			...
			case '0':
			{
				...
				case 'X':  case 'x':
				{
					...
					_loop167:
					do {
						if ((_tokenSet_1.member(LA(1))) && (true) && (true) && (true) && (true)) {
							mHEX_DIGIT(false);
						}
						else {
	...
	public final void mSTRING_LITERAL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		_loop192:
		do {
			if ((_tokenSet_3.member(LA(1))) && (_tokenSet_4.member(LA(2))) && (true) && (true) && (true)) {
				{
				match(_tokenSet_3);
				}
			}
			else if ((LA(1)=='#') && (_tokenSet_4.member(LA(2))) && (true) && (true) && (true)) {
				match('#');
			}
			else if ((LA(1)=='\\')) {
				mESC(false);
	...
	protected final void mESC(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		case '0':  case '1':  case '2':  case '3':
		{
			matchRange('0','3');
			{
			if (((LA(1) >= '0' && LA(1) <= '7')) && (_tokenSet_4.member(LA(2))) && (true) && (true) && (true)) {
				matchRange('0','7');
				{
				if (((LA(1) >= '0' && LA(1) <= '7')) && (_tokenSet_4.member(LA(2))) && (true) && (true) && (true)) {
					matchRange('0','7');
	...
	public final void mML_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
				if ((LA(1)=='\r') && (LA(2)=='\n') && (_tokenSet_4.member(LA(3))) && (_tokenSet_4.member(LA(4))) && (true)) {
					match('\r');
					match('\n');
					newline();
				}
				else if (((LA(1)=='*') && (_tokenSet_4.member(LA(2))) && (_tokenSet_4.member(LA(3))))&&( LA(2)!='/' )) {
					match('*');
				}
				else if ((LA(1)=='\r') && (_tokenSet_4.member(LA(2))) && (_tokenSet_4.member(LA(3))) && (true) && (true)) {
					match('\r');
					newline();
				}
			else {
	...
	private static final long[] mk_tokenSet_2() {
		long[] data = { 70368744177664L, 481036337264L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_2 = new BitSet(mk_tokenSet_2());
	private static final long[] mk_tokenSet_3() {
		long[] data = { -21474822656L, 9223372032291373054L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_3 = new BitSet(mk_tokenSet_3());
	private static final long[] mk_tokenSet_4() {
		long[] data = { -4294953472L, 9223372032559808510L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_4 = new BitSet(mk_tokenSet_4());
	private static final long[] mk_tokenSet_5() {
		long[] data = { -4294962688L, 9223372032559808510L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_5 = new BitSet(mk_tokenSet_5());
	private static final long[] mk_tokenSet_6() {
		long[] data = { -4402341473792L, 9223372032559808510L, 0L, 0L};
		return data;
	}
